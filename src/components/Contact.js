      ...
      <div className="container px-5 py-20 mx-auto flex sm:flex-nowrap flex-wrap">
        ...
        >
          ...
          <p className="leading-relaxed mb-5">
            Thank you for taking the time to view my website. If any of the
            content above piqued your interest, or if you have any questions for
            me, my information is listed below. Please feel free to reach out.
          </p>
